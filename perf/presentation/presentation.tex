...
\tightlist
\item
  \vspace{-0.2cm} Introduction + Travailler sur des données avec R 1
  (généralités, \texttt{*apply()}, etc.) (2h)
\item
  Cas pratiques (2h)
\item
...
\tightlist
\item
  \vspace{-0.2cm} Travailler sur des données 2 avec R (optimisations
  avec base R, dplyr, data.table) (2h)
\item
...
\NormalTok{  ##  rnorm(1e+06) 68.16277 68.84521 69.0792 68.892}
\NormalTok{  ##        uq      max neval}
\NormalTok{  ##  69.05627 70.45888    10}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## <environment: 0xb82b160>}
\KeywordTok{maFun}\NormalTok{()}
\NormalTok{  ## <environment: 0xb667210>}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## 1 boucle 15751.411 16676.220 17342.6323}
\NormalTok{  ## 2 Reduce  5828.524  5945.065  6662.3951}
\NormalTok{  ## 3 cumsum    37.019    39.746    47.2646}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## Unit: milliseconds}
\NormalTok{  ##                    expr       min        lq      mean}
\NormalTok{  ##         boucle(1:10000) 15.805389 17.005351 17.874497}
\NormalTok{  ##  boucle_compil(1:10000)  1.588799  1.722751  1.750571}
\NormalTok{  ##     median        uq       max neval}
\NormalTok{  ##  17.697739 18.263382 21.722003   100}
\NormalTok{  ##   1.738325  1.765799  2.212019   100}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ##                     expr      min       lq     mean}
\NormalTok{  ## 1        boucle(1:10000) 1.582040 1.603213 1.729375}
\NormalTok{  ## 2 boucle_compil(1:10000) 1.585057 1.609157 1.657959}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## Unit: milliseconds}
\NormalTok{  ##    expr      min        lq     mean    median}
\NormalTok{  ##  ifelse 26.25032 26.321084 26.71476 26.460366}
\NormalTok{  ##       [  1.39027  1.431458  1.51165  1.470771}
\NormalTok{  ##         uq       max neval}
\NormalTok{  ##  26.714720 28.400851    10}
\NormalTok{  ##   1.567792  1.750101    10}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## Unit: milliseconds}
\NormalTok{  ##   expr       min        lq     mean    median}
\NormalTok{  ##  merge 14.794181 15.264378 15.40527 15.437613}
\NormalTok{  ##  names  2.611688  2.655904  2.81817  2.736901}
\NormalTok{  ##         uq       max neval}
\NormalTok{  ##  15.636058 15.901694    10}
\NormalTok{  ##   3.019022  3.074043    10}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ##    expr      min       lq       mean    median}
\NormalTok{  ##   dense 1260.470 1281.146 1313.86973 1310.1305}
\NormalTok{  ##  sparse   56.086   70.537   82.59214   83.2135}
\NormalTok{  ##         uq      max neval}
\NormalTok{  ##  1333.8945 1444.225   100}
\NormalTok{  ##    92.3815  148.062   100}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ##   base 36.33509 42.80433 42.41404 43.29193 44.16897}
\NormalTok{  ##  dplyr 53.33831 53.45452 56.14469 55.14207 56.00287}
\NormalTok{  ##       max neval}
\NormalTok{  ##  45.50056    10}
\NormalTok{  ##  65.04266    10}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## Unit: milliseconds}
\NormalTok{  ##  expr      min       lq     mean   median       uq}
\NormalTok{  ##  base 41.71417 43.65880 54.29650 49.23702 50.10314}
\NormalTok{  ##   dt1 10.80914 11.26147 12.90479 11.45061 11.97763}
\NormalTok{  ##   dt2 10.46219 10.81319 13.99015 11.03693 11.68497}
\NormalTok{  ##        max neval}
\NormalTok{  ##  218.69998   100}
\NormalTok{  ##   21.21712   100}
\NormalTok{  ##  179.24473   100}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## Unit: milliseconds}
\NormalTok{  ##                 expr      min       lq     mean}
\NormalTok{  ##         lapply(l, f) 640.6186 641.2107 645.5821}
\NormalTok{  ##  parLapply(cl, l, f) 336.0838 383.6429 400.1393}
\NormalTok{  ##    median       uq      max neval}
\NormalTok{  ##  641.8607 651.6407 659.1777    10}
\NormalTok{  ##  403.8412 424.5455 431.9449    10}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ## 1 cumColSumsR(x) 19.506836 38.770332 25.321596}
\NormalTok{  ## 2 cumColSumsC(x)  4.416819  5.062526  5.752609}
\end{Highlighting}
\end{Shaded}
