...
## Formation \protect\textbf{R} initiation {.unnumbered}
...
\bigskip \pause \strong{Remarque} Tous les supports de la formation ont été produits depuis **R** avec [\link{\textbf{R} Markdown}](http://rmarkdown.rstudio.com/) (*cf.* [\link{\textbf{R} perfectionnement}](http://teaching.slmc.fr/perf)).
